...
function peg$parse(input, options) {
  ...
  function peg$parseCommentBlock() {
    ...
    return s0;
      ...
      var ast = __nccwpck_require__(2825);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
var parser = __nccwpck_require__(1527);
var pbx = __nccwpck_require__(834);
...
var parserFunctions = __nccwpck_require__(4366);
...
var builderFunctions = __nccwpck_require__(8125);
...
var base64 = __nccwpck_require__(878);
var xmlbuilder = __nccwpck_require__(4519);
...
var DOMParser = (__nccwpck_require__(883)/* .DOMParser */ .a);
...
var htmlEntity = __nccwpck_require__(5107);
var sax = __nccwpck_require__(5037);
var XMLReader = sax.XMLReader;
var ParseError = sax.ParseError;
var DOMImplementation = /* unused reexport */ __nccwpck_require__(7939).DOMImplementation;
/* unused reexport */ __nccwpck_require__(7939) ;
exports.a = DOMParser;
...
(function() {
  ...
  XMLNode = __nccwpck_require__(21);
...
(function() {
  ...
  isObject = (__nccwpck_require__(5131).isObject);
...
(function() {
  ...
  XMLDTDAttList = __nccwpck_require__(5407);

  XMLDTDEntity = __nccwpck_require__(2207);

  XMLDTDElement = __nccwpck_require__(7933);

  XMLDTDNotation = __nccwpck_require__(958);
...
(function() {
  ...
  isPlainObject = (__nccwpck_require__(5131).isPlainObject);

  XMLNode = __nccwpck_require__(21);

  XMLStringifier = __nccwpck_require__(6758);

  XMLStringWriter = __nccwpck_require__(8839);
...
(function() {
  ...
  ref = __nccwpck_require__(5131), isObject = ref.isObject, isFunction = ref.isFunction, isPlainObject = ref.isPlainObject;

  XMLElement = __nccwpck_require__(7173);

  XMLCData = __nccwpck_require__(5612);

  XMLComment = __nccwpck_require__(7149);

  XMLRaw = __nccwpck_require__(5064);

  XMLText = __nccwpck_require__(8295);

  XMLProcessingInstruction = __nccwpck_require__(1668);

  XMLDeclaration = __nccwpck_require__(8085);

  XMLDocType = __nccwpck_require__(7404);
  ...
  XMLAttribute = __nccwpck_require__(5266);
...
(function() {
  ...
  ref = __nccwpck_require__(5131), isObject = ref.isObject, isFunction = ref.isFunction;
...
(function() {
  ...
  ref = __nccwpck_require__(5131), isObject = ref.isObject, isFunction = ref.isFunction, isEmpty = ref.isEmpty;
...
(function() {
  ...
  XMLWriterBase = __nccwpck_require__(809);
...
(function() {
  ...
  ref = __nccwpck_require__(5131), assign = ref.assign, isFunction = ref.isFunction;

  XMLDocument = __nccwpck_require__(2188);

  XMLDocumentCB = __nccwpck_require__(5681);

  XMLStringWriter = __nccwpck_require__(8839);

  XMLStreamWriter = __nccwpck_require__(9709);
...
const update_versions_1 = __nccwpck_require__(7219);
const main = async () => {
    const tag = core.getInput('tag');
    const [appVersion, buildVersion] = tag.split('-');
    await (0, update_versions_1.writeBuildAndAppVersions)({
        appVersion,
        buildVersion,
    });
};
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.writeBuildAndAppVersions = void 0;
const path_1 = __importDefault(__nccwpck_require__(1017));
const fs_1 = __importDefault(__nccwpck_require__(7147));
const xcode_1 = __nccwpck_require__(8395);
const plist_1 = __importDefault(__nccwpck_require__(8365));
const lodash_1 = __nccwpck_require__(3255);
const IOS_DIR = path_1.default.join(process.env.GITHUB_WORKSPACE || '', 'ios');
const BUILD_GRADLE_PATH = path_1.default.join(process.env.GITHUB_WORKSPACE || '', 'android/app/build.gradle');
/**
 * Write iOS and Android Build/App versions
 */
const writeBuildAndAppVersions = async ({ appVersion, buildVersion: passedBuildVersion, }) => {
...
exports.writeBuildAndAppVersions = writeBuildAndAppVersions;
/**
...
async function updateIOSVersions({ appVersion, buildVersion }) {
    ...
    const xcodeProjects = fs_1.default.readdirSync(IOS_DIR).filter((file) => /\.xcodeproj$/i.test(file));
    const projectFolder = path_1.default.join(IOS_DIR, xcodeProjects[0]);
    const xcode = xcode_1.Xcode.open(path_1.default.join(projectFolder, 'project.pbxproj'));
...
async function updatePlists({ xcode, appVersion, buildVersion }) {
    ...
    const plistsToSave = plistFileNames.map((filename) => {
        const plistPath = path_1.default.join(IOS_DIR, filename);
        const plistObject = plist_1.default.parse(fs_1.default.readFileSync(plistPath, 'utf8'));
        plistObject.CFBundleShortVersionString = appVersion;
        plistObject.CFBundleVersion = `${buildVersion}`;
        const file = plist_1.default.build(plistObject);
        return fs_1.default.promises.writeFile(plistPath, file);
    });
...
function getPlistFilenames(xcode) {
    return (0, lodash_1.uniq)((0, lodash_1.flattenDeep)(xcode.document.projects.map((project) => {
...
async function updateAndroidVersions({ appVersion, buildVersion }) {
    ...
    let gradleFile = await fs_1.default.promises.readFile(BUILD_GRADLE_PATH);
    ...
    return fs_1.default.promises.writeFile(BUILD_GRADLE_PATH, gradleFile);
}
