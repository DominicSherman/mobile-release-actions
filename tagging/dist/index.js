...
var http = _interopDefault(__nccwpck_require__(181));
var Url = _interopDefault(__nccwpck_require__(310));
var whatwgUrl = _interopDefault(__nccwpck_require__(646));
...
var mappingTable = __nccwpck_require__(118);
...
const usm = __nccwpck_require__(838);
...
const conversions = __nccwpck_require__(44);
const utils = __nccwpck_require__(734);
const Impl = __nccwpck_require__(250);
...
exports.URL = __nccwpck_require__(772)["interface"];
exports.serializeURL = __nccwpck_require__(838).serializeURL;
exports.serializeURLOrigin = __nccwpck_require__(838).serializeURLOrigin;
exports.basicURLParse = __nccwpck_require__(838).basicURLParse;
exports.setTheUsername = __nccwpck_require__(838).setTheUsername;
exports.setThePassword = __nccwpck_require__(838).setThePassword;
exports.serializeHost = __nccwpck_require__(838).serializeHost;
exports.serializeInteger = __nccwpck_require__(838).serializeInteger;
exports.parseURL = __nccwpck_require__(838).parseURL;
...
const tr46 = __nccwpck_require__(570);
...
const github_1 = __nccwpck_require__(872);
const tags_1 = __nccwpck_require__(666);
const validation_1 = __nccwpck_require__(667);
const main = async () => {
    const githubAuthToken = core.getInput('github-auth-token');
    const branchToTag = core.getInput('branch-to-tag') || 'main';
    const versionChangeType = (0, validation_1.validateVersionChangeType)(core.getInput('version-change-type'));
    const buildVersion = core.getInput('build-version') || '1';
    const currentTag = await (0, tags_1.getCurrentTag)(githubAuthToken);
    const newTag = (0, tags_1.getNewTag)({
        buildVersion,
        currentTag,
        versionChangeType,
    });
    await (0, github_1.createGithubTag)({
        githubAuthToken,
        branchToTag,
        currentTag,
        newTag,
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.getMostRecentGithubTag = exports.createGithubTag = void 0;
const node_fetch_1 = __importDefault(__nccwpck_require__(372));
const createGithubTag = async ({ githubAuthToken, branchToTag, currentTag, newTag, }) => {
    ...
    const commitsSinceTagResponse = await (0, node_fetch_1.default)(commitSinceTagUrl, { headers });
    ...
    const commitMessages = commits.map((item) => `* ${item.commit.message} ${item.html_url} - @${item.author.login}`);
    const [owner, repo] = (process.env.GITHUB_REPOSITORY || '').split('/');
    // generate body for release
    const body = `${commitMessages.join('\n ')}`;
    // create release
    await (0, node_fetch_1.default)(`${process.env.GITHUB_API_URL}/repos/${process.env.GITHUB_REPOSITORY}/releases`, {
        body: JSON.stringify({
            owner,
            repo,
            tag_name: newTag,
...
const getMostRecentGithubTag = async (githubAuthToken) => {
    // get existing tags
    const tagsResponse = await (0, node_fetch_1.default)(`${process.env.GITHUB_API_URL}/repos/${process.env.GITHUB_REPOSITORY}/tags`, {
...
exports.getMostRecentGithubTag = getMostRecentGithubTag;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.getNewTag = exports.getVersionFromTag = exports.getCurrentTag = void 0;
const github_1 = __nccwpck_require__(872);
// TAG - v1.0.0-1
// VERSION - 1.0.0
const getCurrentTag = (githubAuthToken) => {
    // TODO pull from GitHub or app.json?
    return (0, github_1.getMostRecentGithubTag)(githubAuthToken);
};
 ...
 */
const getVersionFromTag = (currentTag) => {
...
/**
 * Bump tag based on version change typea
 ...
 */
const getNewTag = ({ currentTag, versionChangeType, buildVersion, }) => {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.validateVersionChangeType = void 0;
const validateVersionChangeType = (versionChangeType) => {
...
exports.validateVersionChangeType = validateVersionChangeType;
...
/******/ 	var __webpack_exports__ = __nccwpck_require__(304);
