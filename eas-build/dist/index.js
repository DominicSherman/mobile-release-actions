...
const eas_1 = __nccwpck_require__(608);
const main = async () => {
    ...
    await (0, eas_1.updateEasAppJson)({
        appleId,
        appleAscAppId,
        appleTeamId,
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.updateEasAppJson = void 0;
const promises_1 = __importDefault(__nccwpck_require__(292));
const updateEasAppJson = async ({ appleId, appleAscAppId, appleTeamId, androidExpoDeployKeyPath, androidSubmitTrack, }) => {
    ...
    await promises_1.default.writeFile(`${process.env.GITHUB_WORKSPACE}/eas.json`, JSON.stringify(json));
};
exports.updateEasAppJson = updateEasAppJson;
